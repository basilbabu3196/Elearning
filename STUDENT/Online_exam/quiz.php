...
{	
		if($submit=='Next Question' && isset($ans))
		{
				...
				mysql_query("insert into mst_useranswer(sess_id, test_id, que_des, ans1,ans2,ans3,ans4,true_ans,your_ans,std_id) values ('".session_id()."', $tid,'$row[2]','$row[3]','$row[4]','$row[5]', '$row[6]','$row[7]','$ans','$std')") or die(mysql_error());
				if($ans==$row[7])
				{
		...
		else if($submit=='Get Result' && isset($ans))
		{
				...
				?>
                <h1 align=center> <a href="review.php?editid=<?php echo $_SESSION[tid];?>"> Review Question</a> </h1>';
                <?php
